...
train_x, test_x, train_y, test_y = train_test_split(
    X, Y, test_size=0.20, random_state=415)
...
learning_rate = 0.3
training_epochs = 50  # Total Number of iterations will be done to minimize the error
cost_history = np.empty(shape=[1], dtype=float)
n_dim = X.shape[1]
print("n_dim = ", n_dim)
n_class = 2
# Path to store the model
model_path = "D:/Study Materials/Python Practice/Tensorflow Tutorial"
